...
- SCSS for styling
- BasicInput component (as a dependency)
...
- **Path**: `src/components/sharedComponents/BasicTextarea.jsx`
- **Description**: Main textarea component implementation
...
- **Path**: `src/assets/scss/components/_basic-textarea.scss`
