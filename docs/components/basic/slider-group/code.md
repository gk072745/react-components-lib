...
- Description: Horizontal card slider with arrows and optional dots
...
- Description: Slider group arrows, dots, and card grid styles
...
- **Description**: Global SCSS variables, mixins, and functions forwarded
