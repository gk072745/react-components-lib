...
DisabledDefaultDemo
} from "@site/src/demoPages/AccordionDemo.jsx";
...
const AnimatedIconDemo = () => {
  ...
  return (
    <BasicAccordion title="Animated Icon Example" prepend={animatedPrepend}>
      <div>
        <p>
          This accordion has an animated arrow icon that rotates when opened.
        </p>
      </div>
    </BasicAccordion>
  );
...
const CounterStatusDemo = () => {
  ...
  return (
    ...
    >
      <div>
        <p>
          This example shows a counter in prepend and status text in append.
        </p>
      </div>
    </BasicAccordion>
  );
  ...
  return (
    <div>
      ...
      >
        <div>
          <p>
            This accordion can be toggled between enabled and disabled states
            using the button above.
          </p>
          <p>
            When disabled, it shows visual feedback and prevents interactions.
          </p>
        </div>
      </BasicAccordion>
    </div>
...
const DisabledDefaultDemo = () => {
  return (
    <BasicAccordion title="Disabled Default Accordion" disabled={true}>
      <div>
        <p>
          This accordion is disabled but uses the default prepend and append
          styling.
        </p>
