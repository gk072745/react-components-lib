...
- SCSS for styling
- React Portal (createPortal) for rendering
- useRemToPixels hook for offset calculations
...
- **Path**: `src/components/sharedComponents/BasicMenu.jsx`
- **Description**: Main menu component implementation
...
- **Path**: `src/assets/scss/components/_basic-menu.scss`
- **Description**: Menu component styles
