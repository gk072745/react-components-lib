...
const CheckboxDemo = () => {
  ...
  return (
    <Layout title="Checkbox Demo" description="Interactive checkbox component demos">
      <main style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
        <h1>BasicCheckbox Interactive Demos</h1>
        <p>Explore all the features and variations of the BasicCheckbox component.</p>

        {/* Demo 1: Basic Checkbox */}
        <section style={{ marginTop: '2rem', padding: '1.5rem', border: '1px solid #e1e5e9', borderRadius: '8px' }}>
          <h3>Demo 1: Basic Checkbox</h3>
          <BasicCheckbox 
        ...
        <section style={{ marginTop: '2rem', padding: '1.5rem', border: '1px solid #e1e5e9', borderRadius: '8px' }}>
          <h3>Demo 5: Select All Functionality</h3>
        ...
        <section style={{ marginTop: '2rem', padding: '1.5rem', border: '1px solid #e1e5e9', borderRadius: '8px' }}>
          <h3>Demo 6: Custom Icon and Label</h3>
          <BasicCheckbox
            value="custom"
            selected={selectedItems}
            onChange={handleCheckboxChange}
        ...
        <section style={{ marginTop: '2rem', padding: '1.5rem', border: '1px solid #e1e5e9', borderRadius: '8px' }}>
          <h3>Demo 7: Multiple Checkboxes</h3>
        ...
        <section style={{ marginTop: '2rem', padding: '1.5rem', border: '1px solid #e1e5e9', borderRadius: '8px' }}>
          <h3>Demo 8: Current Selection</h3>
          <div
            style={{
              padding: '1rem',
        ...
        <section style={{ marginTop: '2rem', padding: '1.5rem', border: '1px solid #e1e5e9', borderRadius: '8px' }}>
          <h3>Demo 9: Different Value Types</h3>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <BasicCheckbox
              label="String Value"
              value="string-value"
