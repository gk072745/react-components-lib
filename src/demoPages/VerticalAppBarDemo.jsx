...
const useSampleData = () => {
  const logoSvg =
    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 2l3.09 6.26L22 9.27l-5 4.87L18.18 22L12 18.77L5.82 22L7 14.14l-5-4.87l6.91-1.01L12 2z"/></svg>';
...
export const BasicUsageDemo = () => {
  ...
  return (
    <div className="vertical-app-bar-demo-container">
      <div className="demo-section">
        ...
        <div className="demo-content">
          <div className="app-bar-container">
            ...
            <div
              className="content"
              style={{ marginLeft: mounted && open ? "20rem" : "0" }}
            >
              <div className="button-group">
                <button
                  className={`demo-button ${mounted ? "danger" : ""}`}
...
export const WithLogoDemo = () => {
  ...
  return (
    <div className="vertical-app-bar-demo-container">
      <div className="demo-section">
        <h3 className="demo-title">With Logo</h3>
        <div className="demo-content">
          <div className="app-bar-container">
            {mounted && (
              <VerticalAppBar
            ...
            >
              ...
              <p>
                Logo: <code>SVG</code>, Rounded: <code>true</code>
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="demo-section">
        ...
        <div className="demo-content">
          <div className="app-bar-container">
            ...
            <div
              className="content"
              style={{ marginLeft: mounted && open ? "250px" : "0" }}
            >
              <div className="button-group">
                <button
                  className={`demo-button ${mounted ? "danger" : ""}`}
              ...
              <p>
                Background: <code>#34495e</code>, Width: <code>250px</code>
              </p>
            </div>
          </div>
        </div>
...
export const WithNavigationItemsDemo = () => {
  ...
  return (
    <div className="vertical-app-bar-demo-container">
      <div className="demo-section">
        <h3 className="demo-title">With Navigation Items</h3>
        <div className="demo-content">
          <div className="app-bar-container">
            {mounted && (
              <VerticalAppBar
            ...
            >
              ...
              <p>
                Active Item: <code>{active || "none"}</code>
              </p>
            </div>
          </div>
        </div>
...
export const AdvancedFeaturesDemo = () => {
  ...
  return (
    <div className="vertical-app-bar-demo-container">
      <div className="demo-section">
        <h3 className="demo-title">Advanced Features</h3>
        <div className="demo-content">
          <div className="app-bar-container">
            {mounted && (
              <VerticalAppBar
            ...
            >
              ...
              <p>
                Persist Icons: <code>true</code>, Expand on Hover: <code>true</code>, Multi
                Expand: <code>true</code>
              </p>
            </div>
          </div>
        </div>
...
export const NestedItemsDemo = () => {
  ...
  return (
    <div className="vertical-app-bar-demo-container">
      <div className="demo-section">
        <h3 className="demo-title">Nested Items</h3>
        <div className="demo-content">
          <div className="app-bar-container">
            {mounted && (
              <VerticalAppBar
...
export const PositionVariantsDemo = () => {
  const { logoSvg, navigationItems } = useSampleData();
  const [mounted, setMounted] = useState(false);
  const [open, setOpen] = useState(false);
  ...
  return (
    <div className="vertical-app-bar-demo-container">
      <div className="demo-section">
        <h3 className="demo-title">Position Variants</h3>
        <div className="demo-content">
          <div className="app-bar-container two-bars">
            ...
            >
              ...
              <p>
                Left Active: <code>{activeLeft || "none"}</code> | Right Active:{" "}
                <code>{activeRight || "none"}</code>
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="demo-section">
        ...
        <div className="demo-content">
          <div className="app-bar-container">
            ...
            <div
              className="content"
              style={{ marginLeft: mounted && open ? "22rem" : "0" }}
            >
              <div className="button-group">
                <button
                  className={`demo-button ${mounted ? "danger" : ""}`}
...
// Main Demo Component
export default function VerticalAppBarDemo() {
  return (
    <div className="vertical-app-bar-demo-container">
      <BasicUsageDemo />
      <WithLogoDemo />
